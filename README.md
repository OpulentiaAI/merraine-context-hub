...
|---|---|
| `types/` | The ontology. 23 types covering orgs, people, signals, sequences, automations, extractions, evidence. |
...
| `skills/`, `injects/`, `agents/` | What an Opulent session sees: triggered guidance, standing context, and agent profiles. |
