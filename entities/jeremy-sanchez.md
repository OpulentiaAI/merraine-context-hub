...
- Breadth at the top of the funnel, then filter. You would rather see the signal
  and drop it than miss it.
- You watch people in motion — who reacted, reposted, or commented — more than
  static database rows.
- One keyword vocabulary everywhere. The same recruiting language is pasted
  across LinkedIn, X, Reddit, podcasts, and news. See [[spear-signal-vocabulary]].
- Messages are written for one person. No blast template.
- Faith, family, and Chicago are real themes, not decoration.

When anything is written in your name, use [[jeremy-voice]].
